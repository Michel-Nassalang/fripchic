							...
							<div class="form-main">
								...
								<form class="form" method="post" action="mail/mail.php">
									<div class="row">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Votre Numéro Téléphone<span>*</span></label>
										...
										<div class="col-12">
											<div class="form-group button">
												<button type="submit" class="btn ">Envoyez Message</button>
											</div>
										</div>
									</div>
								</form>
						...
						<div class="col-lg-4 col-12">
							<div class="single-head">
								...
								<div class="single-info">
									...
									<ul>
										<li><a href="mailto:info@yourwebsite.com">info.fripchic@gmail.com</a></li>
										<li><a href="mailto:info@yourwebsite.com">clientele.fripchic@gmail.com</a></li>
									</ul>
								</div>
								<div class="single-info">
									...
									<ul>
										<li>Saly Darou Extension, Saly, Mbour, Sénégal</li>
									</ul>
								</div>
							</div>
						</div>
