					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="blog-single.php">Blog Client</a></li>
							</ul>
						</div>
					</div>
				</div>
							...
							<div class="row">
								<div class="col-12">
									...
									<div class="blog-detail">
										<h2 class="blog-title">Quels sont les secrets du succès de votre start-up ?</h2>
										<div class="blog-meta">
											<span class="author"><a href="#"><i class="fa fa-user"></i>Par l'administrateur</a><a href="#"><i class="fa fa-calendar"></i>Dec 24, 2021</a><a href="#"><i class="fa fa-comments"></i>Commentaires (15)</a></span>
										</div>
										<div class="content">
								...
								<div class="col-12">
									<div class="comments">
										<h3 class="comment-title">Commentaires (3)</h3>
										<!-- Single Comment -->
										<div class="single-comment">
											...
											<div class="content">
												...
												<div class="button">
													<a href="#" class="btn"><i class="fa fa-reply" aria-hidden="true"></i>Répondre</a>
												</div>
											</div>
										</div>
										<!-- End Single Comment -->
								...
								<div class="col-12">			
									<div class="reply">
										<div class="reply-head">
											<h2 class="reply-title">Mon commentaire</h2>
											<!-- Comment Form -->
					...
					<div class="col-lg-4 col-12">
						<div class="main-sidebar">
							...
							<div class="single-widget search">
								<div class="form">
									<input type="email" placeholder="Rechercher ici...">
							...
							<div class="single-widget category">
								...
								<ul class="categor-list">
									<li><a href="#">Vêtements Homme</a></li>
									<li><a href="#">Vêtements Femme</a></li>
									<li><a href="#">Collection de Sacs</a></li>
							...
							<div class="single-widget recent-post">
								...
								<div class="single-post">
									...
									<div class="content">
										<h5><a href="#">Top 10 des plus belles robes</a></h5>
										<ul class="comment">
								...
								<div class="single-post">
									...
									<div class="content">
										<h5><a href="#">Top 10 des plus beaux pantalons</a></h5>
										<ul class="comment">
											<li><i class="fa fa-calendar" aria-hidden="true"></i>Mar 05, 2021</li>
								...
								<div class="single-post">
									...
									<div class="content">
										<h5><a href="#">Top 10 des plus beaux lunettes</a></h5>
										<ul class="comment">
											<li><i class="fa fa-calendar" aria-hidden="true"></i>June 09, 2020</li>
							...
							<div class="single-widget newsletter">
								...
								<div class="letter-inner">
									<h4>S'inscrire pour les news <br> Derniers mises à jour.</h4>
