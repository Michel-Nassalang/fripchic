 <div class="sidebar-menu">
    ...
    <div class="down">  
        <?php
$aid=$_SESSION['admin'];
$sql="SELECT nom_user from  administrateur where id=:aid";
...
{               ?>
        ...
        <a href="dashboard.php"><span class=" name-caret"><?= $row->nom_user;?></span></a>
        ...
        <ul id="menu" >
            ...
            <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> Services</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                <ul id="menu-academico-sub" >
                    <li id="menu-academico-avaliacoes" ><a href="add-article.php"> Ajouter un article</a></li>
                    <li id="menu-academico-avaliacoes" ><a href="add-category.php"> Ajouter une catégorie</a></li>
                    <li id="menu-academico-boletim" ><a href="manage-article.php">gérer un article</a></li>
                    <li id="menu-academico-boletim" ><a href="manage-category.php">gérer une catégorie</a></li>
                   
                </ul>
            </li>
            <li><a href="add-client.php"><i class="fa fa-user"></i> <span>Affichages</span></a></li>
