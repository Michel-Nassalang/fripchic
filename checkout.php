					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="blog-single.php">Caisse</a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="row"> 
					<div class="col-lg-8 col-12">
						<div class="checkout-form">
							<h2>Mon checkout</h2>
							<p>Veillez inscrire vos informations</p>
							<!-- Form -->
							<form class="form" method="post" action="#">
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											<label>Numéro de télephone<span>*</span></label>
									...
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											...
											<select name="country_name" id="country">
												...
												<option value="PD">Podor</option>
												<option value="MT">Matam</option>
												<option value="KD">Kolda</option>
												<option value="SD">Siedhou</option>
									...
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											<label>Département / Commune<span>*</span></label>
											<input type="text" name="department" placeholder="" required="required">
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
