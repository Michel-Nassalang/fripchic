						...
						<div class="row">
							<div class="col-12">
								...
								<div class="shop-top">
									...
									<ul class="view-mode">
										<li><a href="boutique-grid.php"><i class="fa fa-th-large"></i></a></li>
										<li class="active"><a href="boutique-list.php"><i class="fa fa-th-list"></i></a></li>
									</ul>
								</div>
								<!--/ End Shop Top -->
							</div>
												...
												<div class="product-img">
													...
													<div class="button-head">
														<div class="product-action">
															<a data-toggle="modal" data-target="#exampleModal" title="" href="?produits=<?= $retour->id ?>"><i class=" ti-eye"></i><span>Voir produit</span></a>
															<a title="" href="#"><i class=" ti-heart "></i><span>Ajouter aux souhaits</span></a>
															<a title="" href="#"><i class="ti-bar-chart-alt"></i><span>Voir similaires</span></a>
														</div>
										...
										<div class="col-lg-8 col-md-6 col-12">
											<div class="list-content">
												<div class="product-content">
													...
													<h3 class="title"><a href="?produits=<?= $retour->id ?>"><?= $retour->nom ?></a></h3>
												...
												<p class="des"><?= $retour->description ?></p>
