					...
					<div class="col-lg-7 col-md-12 col-12">
						...
						<div class="right-content">
							<ul class="list-main">
								...
								?>
								<li><i class="ti-power-off"></i><a href="parts/deconnexion.php">Deconnexion</a></li>
								<?php 	
								}else{ 	
								?>
						...
						<div class="col-lg-3">
							<div class="all-category">
								...
								<ul class="main-category">
									<li><a href="#">Nouvelles arrivages <i class="fa fa-angle-right" aria-hidden="true"></i></a>
										<ul class="sub-category">
											...
											<li><a href="#">Articles Homme</a></li>
											<li><a href="#">Articles Femme</a></li>
										...
										<ul class="mega-menu">
											<li class="single-menu">
												...
												<div class="inner-link">
													<a href="#">Jouets Enfants</a>
													<a href="#">Soins Enfants</a>
													<a href="#">Habits Enfants</a>
													<a href="#">Jeans Enfants</a>
												</div>
											</li>
											<li class="single-menu">
												<a href="#" class="title-link">Boutique pour Hommes</a>
												<div class="image">
											...
											<li class="single-menu">
												<a href="#" class="title-link">Boutique pour Femmes</a>
												<div class="image">
													<img src="images/mega-menu3.jpg" alt="#">
												</div>
												<div class="inner-link">
													<a href="#">Tshirts</a>
													<a href="#">Articles Femmes </a>
													<a href="#">Lunettes</a>
													<a href="#">Montres</a>
												</div>
											</li>
									...
									<div class="navbar-collapse">	
										<div class="nav-inner">	
											<ul class="nav main-menu menu navbar-nav">
													<li class="active"><a href="index.php">Acceuil <i class="ti-angle-down"></i></a>
														<ul class="dropdown">
															<li><a href="index.php">Acceuil</a></li>
															<li><a href="">Acceuil 2</a></li>
															<li><a href="">Acceuil 3</a></li>
															<li><a href="i">Acceuil 4</a></li>
														</ul>
													</li>
						...
						<div class="text-inner">
							<div class="row">
								<div class="col-lg-7 col-12">
									<div class="hero-text">
										<h1><span>50% de Réduction </span>T-shirts pour Homme</h1>
										<p>Achète et Savoure <br> Trouve la qualité avec le bon prix <br> Le bon choix reste crucial.</p>
										<div class="button">
											<a href="#" class="btn">Fais ton choix !</a>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 col-12">
					<div class="single-banner">
						...
						<div class="content">
							...
							<h3>Summer Vibes<br> collection</h3>
				...
				<div class="col-lg-4 col-md-6 col-12">
					<div class="single-banner">
						...
						<div class="content">
							<p>Collections de Sacs</p>
							<h3>Superbes sacs <br> 2021</h3>
							<a href="#">Achète maintenant</a>
						</div>
					</div>
				</div>
				<!-- /End Single Banner  -->
				...
				<div class="col-lg-4 col-12">
					<div class="single-banner tab-height">
						...
						<div class="content">
							<p>Vente Flash </p>
							<h3>Mi-Saison <br> Réduction <span>40%</span> </h3>
							<a href="#">Découvrir mmaintenant</a>
						</div>
					</div>
				</div>
				<!-- /End Single Banner  -->
						...
						<div class="product-info">
							<div class="nav-main">
								...
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									...
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#accessories" role="tab">Accesoires</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#essential" role="tab">Essentiels</a></li>
										...
										<div class="row">
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													<div class="product-img">
														<a href="produits-page.php">
															<img class="default-img" src="images/products/p1.jpg" alt="#">
															<img class="hover-img" src="images/products/p2.jpg" alt="#">
														</a>
														<div class="button-head">
															<div class="product-action">
																<a data-toggle="modal" data-target="#exampleModal" title="Quick View" href="#"><i class=" ti-eye"></i><span>Achats rapides</span></a>
																<a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Ajouter à la liste liste de souhaits</span></a>
													...
													<div class="product-content">
														<h3><a href="produits-page.php">Hot Collection Femmes</a></h3>
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="produits-page.php">Awesome Pink Show</a></h3>
														<div class="product-price">
															<span>$29.00</span>
														</div>
													</div>
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="produits-page.php">Awesome Bags Collection</a></h3>
														<div class="product-price">
															<span>$29.00</span>
														</div>
													</div>
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="produits-page.php">Women Pant Collectons</a></h3>
														<div class="product-price">
															<span>$29.00</span>
														</div>
													</div>
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="produits-page.php">Awesome Cap For Women</a></h3>
														<div class="product-price">
															<span>$29.00</span>
														</div>
													</div>
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="produits-page.php">Polo Dress For Women</a></h3>
														<div class="product-price">
															<span>$29.00</span>
														</div>
													</div>
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="produits-page.php">Black Sunglass For Women</a></h3>
														<div class="product-price">
										...
										<div class="row">
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="produits-page.php">Women Hot Collection</a></h3>
														<div class="product-price">
															<span>$29.00</span>
														</div>
													</div>
										...
										<div class="row">
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													<div class="product-img">
														<a href="produits-page.php">
															<img class="default-img" src="images_produits/Pri-Nike.png" alt="#">
															<img class="hover-img" src="images_produits/Pri-Nike.png" alt="#">
														</a>
														<div class="button-head">
															<div class="product-action">
																<a data-toggle="modal" data-target="#exampleModal" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
										...
										<div class="row">
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													<div class="product-img">
														<a href="produits-page.php">
															<img class="default-img" src="images/products/p2.jpg" alt="#">
															<img class="hover-img" src="images/products/p4.jpg" alt="#">
															<span class="out-of-stock">Hot</span>
														</a>
														<div class="button-head">
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-12">
					<div class="single-banner">
						...
						<div class="content">
							<p>Collections pour Hommes </p>
							<h3> Articles Homme<br>Plus de <span> 50%</span></h3>
							<a href="#">Voir</a>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-6 col-md-6 col-12">
					<div class="single-banner">
						...
						<div class="content">
							<p>Chaussures Femmes</p>
							<h3>Mi-Saison<br> Plus de <span>70%</span></h3>
            ...
            <div class="row align-items-center">
                <div class="col-md-8 offset-md-2 col-xs-12">
                    <div class="section-title mb-60">
                        <span class="text-white wow fadeInDown" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInDown;">Frip Chic pour le bon choix</span>
                        <h2 class="text-white wow fadeInUp" data-wow-delay=".4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">Présentement dans le bon coin<br> Pour le meilleur</h2>
                        <p class="text-white wow fadeInUp" data-wow-delay=".6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">Personnalise ton look <br> Avec une personnalité prestigieuse.</p>

                        <div class="button">
                            <a href="https://wpthemesgrid.com/downloads/eshop-ecommerce-html5-template/" target="_blank" rel="nofollow" class="btn wow fadeInUp" data-wow-delay=".8s">Fais ton shopping</a>
                        </div>
                    </div>
                </div>
            </div>
					...
					<div class="col-lg-6 col-12 padding-left">
						<div class="content">
							<div class="heading-block">
								<p class="small-title">Deal du jour</p>
								<h3 class="title">Belles Robes pour Femmes</h3>
								<p class="text"> Mes dames venaient vous faire belles à des prix abordables.... </p>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 col-12">
					...
					<div class="shop-single-blog">
						...
						<div class="content">
							<p class="date">06 Septembre , 2021. Lundi</p>
